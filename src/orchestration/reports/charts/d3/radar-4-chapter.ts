  ...
  return `
    <div class="chapter-radar-container" style="text-align: center; margin: 24pt 0; page-break-inside: avoid;"
      ...
      <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}"
        ...
        <!-- Legend -->
        <g transform="translate(${width - 140}, ${height - 50})">
          <line x1="0" y1="0" x2="25" y2="0" stroke="${BRAND_COLORS.navy}" stroke-width="3"/>
          <text x="30" y="4" font-size="10" fill="#666">${escapeHtml(data.companyName)}</text>
          ${
            showBenchmark
              ? `
            <line x1="0" y1="16" x2="25" y2="16" stroke="#999" stroke-width="2" stroke-dasharray="6,3"/>
            <text x="30" y="20" font-size="10" fill="#666">Benchmark</text>
          `
              : ''
          }
        </g>
